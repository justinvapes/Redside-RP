...
Config.MenuTitleCustom = 'RedSide RP'
...
Config.LEOVehiclesCategories = {
    ...
    ['LSPD'] = {
		{name = '2001 Excursion', spawncode = 'excursion', livery = 1, extras = {1, 2, 3, 4, 5, 7, 10, 11}},
		{name = '2014 explorer', spawncode = 'explorer13', livery = 1, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2016 Explorer', spawncode = 'explorer16', livery = 1, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2014 Charger', spawncode = 'charger14', livery = 1, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = 'Taurus', spawncode = 'taurus', livery = 1, extras = {1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12}},
		{name = '2018 charger', spawncode = 'charger18', livery = 1, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2016 tahoe', spawncode = 'tahoe', livery = 1, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2020 Raptor', spawncode = '2020raptor', livery = 0, extras = {1, 2, 3, 4, 5}},
	},
	
    ['BCSO'] = {
		{name = 'Crown Vic', spawncode = 'vic', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2013 Explorer', spawncode = 'explorer13', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2014 Charger', spawncode = 'charger14', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2016 Explorer', spawncode = 'explorer16', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = 'Taurus', spawncode = 'taurus', livery = 0, extras = {1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12}},
		{name = '2001 Excursion', spawncode = 'excursion', livery = 0, extras = {1, 2, 3, 4, 5, 7, 10, 11}},
		{name = '2018 charger', spawncode = 'charger18', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2016 tahoe', spawncode = 'tahoe', livery = 0, extras = {1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12}},
		{name = '2020 Camaro', spawncode = '20camaro', livery = 1, extras = {1, 2, 4, 5}},
		{name = 'Dodge Ram', spawncode = 'ram', livery = 0, extras = {1, 2, 3, 4, 5, 6, 7, 8, 10, 11}},
	},

    ['Unmarked'] = {
        {name = 'Unmarked', spawncode = 'police4'},
	{name = 'Corvette', spawncode = 'forgieC7'},
	{name = '2016 Potatoe', spawncode = 'polchal', livery = 0, extras = {1, 2, 3}},
	{name = '2020 Camaro', spawncode = '20camaro', livery = 0, extras = {1, 4, 5}},
	{name = '2020 Raptor', spawncode = '2020raptor', livery = 1, extras = {2, 3, 4, 5}},
	{name = 'Camaro', spawncode = 'so14', livery = 0, extras = {2, 3, 4, 5}},
	{name = 'Hellcat undercover', spawncode = 'hellcatRED', livery = 1, extras = {2, 3, 4, 5, 7, 9, 10, 11}},
    },
}
...
Config.FireVehicles = {
	...
	{name = 'FireEngine 51', spawncode = 'firetruk13'},
	{name = 'Ambulance', spawncode = 'ambulance'},
	{name = 'Brush', spawncode = 'brush1', extras = {1, 2, 3}},
	{name = 'Heavy Rescue', spawncode = 'hrescue', extras = {1, 2, 5}},
	{name = 'FireEngine 1', spawncode = 'typhoon'},
}
